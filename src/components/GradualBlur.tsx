...
const GradualBlur: React.FC<GradualBlurProps> = (props) => {
  ...
  }, [props]) // Updated to include props instead of props.preset

  const responsiveHeight = useResponsiveDimension(props.responsive, config, "height")
  const responsiveWidth = useResponsiveDimension(props.responsive, config, "width")

  const isVisible = useIntersectionObserver(containerRef, props.animated === "scroll")
