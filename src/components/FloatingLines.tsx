...
vec3 getLineColor(float t, vec3 baseColor) {
  ...
  // Default fallback if no gradient is passed: Neon Purple/Blue
  if (lineGradientCount == 0) return vec3(0.5, 0.5, 1.0);
...
float wave(vec2 uv, float offset, vec2 screenUv, vec2 mouseUv, bool shouldBend) {
  ...
  // Thinner, sharper lines for "Neon" look
