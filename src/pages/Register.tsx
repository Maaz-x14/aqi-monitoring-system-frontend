...
import { registerUser } from "@/api/authApi"; // Keeping register API
  ...
  return (
    <div className="min-h-screen bg-[#030303] flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="w-full h-full">
          <FloatingLines
            ...
            interactive={true}
            parallax={true}
            // Neon gradients to match Login.tsx
            linesGradient={['#a855f7', '#ec4899', '#3b82f6']}
          />
        </div>
      </div>

      {/* Register Content - z-10 to float above the canvas */}
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        {/* Form Card: White card on Dark BG */}
        <div className="bg-white py-8 px-4 shadow-2xl sm:rounded-2xl sm:px-10 border border-gray-100/10">
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              ...
              <div className="relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className={`block w-full pl-10 pr-10 py-2.5 border rounded-lg leading-5 bg-gray-50 placeholder-gray-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-purple-500 focus:border-purple-500 sm:text-sm transition-all duration-200 ${errors.password ? "border-red-300 focus:ring-red-500 focus:border-red-500" : "border-gray-300"}`}
                />
                <button
                  type="button"
            ...
            {/* Submit Button - Matched Purple Theme */}
            <div>
              <Button
                type="submit"
                isLoading={isLoading}
                className="w-full flex justify-center items-center gap-2 py-2.5 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-colors"
              >
